---
title: "Introduction to RMarkdown files"
...
2) Every time you start an R session or create an R Markdown file, you will need to require the package, using the code `library(ggformla)`.
