...
**Option 2:**
Install R and Rstudio onto your desktop computer, then `Clone or Download` the files from [GitHub](https://github.com/rpruim/JMM2019).
 ...
 * Example Rmd files:
    * <IntroToRMarkdown/IntroductionToRMD_P1.Rmd>
    * <IntroToRMarkdown/IntroductionToRMD_P2.Rmd>
