...
* Using R to create and evaluate statistical models

#### Resources

 * Modeling Data in R: 

If the above tutorial is not working properly, we have several backup options:

* Downloan an RMD file: [ModelingCarsBasic/ModelingData.Rmd](ModelingCarsBasic/ModelingData.Rmd)
* Downloan data:[GMCars1.csv](ModelingCarsBasic/data/GMCars1.csv)
* Downloan data:[GMCars2.csv](ModelingCarsBasic/data/GMCars2.csv)
* You can view as a presentation here: http://rpubs.com/skuiper/ModelingCars
* If you have an rstudio.cloud account, you can access and run the code here: <https://rstudio.cloud/project/179181> 

* Additional tutorials and projects (case studies) on using R: <http://web.grinnell.edu/individuals/kuipers/stat2labs/RTutorials.html>  These include tidy data, visualizations, working with text files, working with dates and times, and making maps.
