...
* Modeling Data in R: <http://shiny.grinnell.edu/ModelingCarData/>


If the above tutorial is not working properly, we have several backup options:

* Download an RMD file: [ModelingCarsBasic/ModelingData.Rmd](ModelingCarsBasic/ModelingData.Rmd)
* Download data: [GMCars1.csv](ModelingCarsBasic/data/GMCars1.csv)
* Download data: [GMCars2.csv](ModelingCarsBasic/data/GMCars2.csv)
